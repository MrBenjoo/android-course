...
public class IncomeDB extends SQLiteOpenHelper {
    private final String TAG = "IncomeDB";
    ...
    private ContentValues getContentValues(Transaction income) {
        ContentValues values = new ContentValues();
        values.put(COLUMN_TITLE, income.getTitle());
        ...
        values.put(COLUMN_IMG, income.getImgRes());
        values.put(COLUMN_BARCODE, income.getBarcode());
        return values;
    }
    ...
    public void updateBarcodeTransaction(Transaction income) {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues values = getContentValues(income);
        db.update(TABLE_NAME, values, "barcode = ?", new String[]{income.getBarcode()});
    }
